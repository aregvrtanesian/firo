...
Scalar Chaum::challenge(const std::vector<GroupElement>& S, const std::vector<GroupElement>& T, const GroupElement& A1, const std::vector<GroupElement>& A2) {
...
void Chaum::prove(const std::vector<Scalar>& x, const std::vector<Scalar>& y, const std::vector<Scalar>& z, const std::vector<GroupElement>& S, const std::vector<GroupElement>& T, ChaumProof& proof) {
    ...
    Scalar c = challenge(S, T, proof.A1, proof.A2);
...
bool Chaum::verify(const std::vector<GroupElement>& S, const std::vector<GroupElement>& T, ChaumProof& proof) {
